...
export default function Explore({
  ...
  const cities = useMemo(() => [...new Set(spaces.map((s) => s.address.city))].sort(), [spaces]);
    ...
    <div>
            ...
            <div className="filter-popover">
              <div className="fp-section">
                ...
                <div className="fp-chip-row">
                  ...
                  {categories.map((c) => {
                    const CatIcon = CAT_ICON_COMPONENT[c.id] ?? CAT_ICON_FALLBACK;
                    return (
                      <button
                        key={c.id}
              ...
              <div className="fp-section">
                ...
                <div className="fp-chip-row">
                  <button className={`fp-chip ${city === "ALL" ? "active" : ""}`} onClick={() => setCity("ALL")}>
                    All cities
                  </button>
                  {cities.map((c) => (
                    <button key={c} className={`fp-chip ${city === c ? "active" : ""}`} onClick={() => setCity(c)}>
                      {c}
                    </button>
                  ))}
                </div>
              ...
              <div className="fp-foot">
                ...
                <button className="btn primary sm" onClick={() => setFiltersOpen(false)}>
      ...
      {loading ? (
        ...
        <div className="empty">
          ...
          <div className="empty-p">Try widening the city, clearing the search, or browsing a different category.</div>
        </div>
      ) : (
